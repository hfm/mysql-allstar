...
Vagrant.configure("2") do |config|
  ...
  config.vm.define "centos5-i386" do |c|
    ...
    c.vm.network :forwarded_port, guest: 80,   host: 8082
  ...
  config.vm.define "centos5-x86" do |c|
    ...
    c.vm.network :forwarded_port, guest: 80,   host: 8083
  ...
  config.vm.define "centos6-i386" do |c|
    ...
    c.vm.network :forwarded_port, guest: 80,   host: 8084
  ...
  config.vm.define "centos6-x86" do |c|
    ...
    c.vm.network :forwarded_port, guest: 80,   host: 8085
